                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="row g-3" method="post" action="{{ route('admin.apiservices.update',$api_service->id) }}" id="apiServiceForm">
                                @csrf
                                @method('PUT')
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ $api_service->name }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" value="{{ $api_service->slug }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('base_url') is-invalid @enderror"
                                        id="base_url" name="base_url" value="{{ $api_service->base_url }}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('auth_type') is-invalid @enderror"
                                        id="auth_type" name="auth_type" value="{{ $api_service->auth_type }}" placeholder="Auth Type (apikey, bearer, basic, etc)"
                                        required>
                                    @error('auth_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" checked type="checkbox" {{ $api_service->is_active == 1 ? 'checked' : '' }} name="is_active" value="1" role="switch" id="statusCheckToggle">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="repeater">
                                        @foreach (json_decode($api_service->credentials) as $key => $credential)
                                            <div class="row mb-3 repeater-item">
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control key-input" value="{{ $key }}" placeholder="Key">
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control value-input" value="{{ $credential }}" placeholder="Value">
                                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="header-repeater">
                                        @foreach (json_decode($api_service->headers) as $key => $header)
                                        <div class="row mb-3 header-repeater-item">
                                            <div class="col-md-5">
                                                <input type="text" class="form-control header-key-input" value="{{ $key }}" placeholder="Key">
                                            </div>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control header-value-input" value="{{ $header }}" placeholder="Value">
                                            </div>
                                            <div class="col-md-2 d-grid">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" id="notes" class="form-control">{{ $api_service->notes }}</textarea>
                                </div>
