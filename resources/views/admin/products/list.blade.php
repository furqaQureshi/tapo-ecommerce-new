...
@section('page-content')
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-0">
                                    {{-- <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                        data-bs-target="#productSettingModal">
                                        <i class="ri ri-settings-5-line"></i> Settings
                                    </button> --}}
    ...
    <!-- Modal -->
    <div class="modal fade" id="productSettingModal" tabindex="-1" aria-labelledby="productSettingModal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productSettingModal">Products Setting</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('setProductMargin') }}" id="formProductMargin" method="POST">
                        @csrf
                        @method('POST')
                        <label for="product_margin" class="form-label">Third Party Product Margin (%)</label>
                        <input type="text" id="product_margin" name="product_margin"
                            value="{{ $settings->product_margin }}" class="form-control" placeholder="e.g: 3">
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                    <button type="submit" form="formProductMargin" class="btn btn-danger">Save</button>
                </div>
            </div>
        </div>
    </div>
