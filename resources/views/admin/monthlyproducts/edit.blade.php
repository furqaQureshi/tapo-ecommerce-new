                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="p-0">
                                    <h4 class="card-title mb-0 flex-grow-1">Edit Monthly Products</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ route('monthly-product.update', $bundle->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-12">
                                    <div class="text-right">
                                        <a href="{{ route('monthly-product.index') }}" class="btn btn-light">Cancel</a>
