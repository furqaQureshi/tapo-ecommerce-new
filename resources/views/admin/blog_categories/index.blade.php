                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="p-0">
                                    <h4 class="card-title mb-0 flex-grow-1">Blog Categories</h4>
                                </div>
                                <div class="p-0">
                                    <a href="{{ route('admin.blogcategory.add') }}" class="btn btn-danger"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.status', function() {
                ...
                var url = "{{ route('admin.blogcategory.status', ':id') }}";
            ...
            $(document).on('click', '.delete-btn', function() {
                var id = $(this).data('id');
                var url = "{{ route('admin.blogcategory.destroy', ':id') }}";
                url = url.replace(':id', id);
