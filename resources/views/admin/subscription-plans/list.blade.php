                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="p-0">
                                    <h4 class="card-title mb-0 flex-grow-1">Subscription Plans</h4>
                                </div>
                                <div class="p-0">
                                    <a href="{{ route('admin.subscription-plan.add') }}" class="btn btn-danger"
                                        data-name="memberAdd"><img src="{{ asset('admin/assets/images/svg/add.svg') }}"
                                            width="12" class="me-1"> Add Subscription Plan</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#members-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.subscription-plan.get') }}",
                    type: "GET",
