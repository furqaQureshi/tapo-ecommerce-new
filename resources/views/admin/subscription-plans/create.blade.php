                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="card-title mb-0 flex-grow-1">Add Subscription Plan</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            @endif
                            <form class="row g-3" method="POST" action="{{ route('admin.subscription-plan.store') }}"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control form-select @error('status') is-invalid @enderror"
                                        ...
                                        @foreach ([1 => 'active', 0 => 'inactive'] as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('status') == (string)$value ? 'selected' : '' }}>
                                                {{ ucfirst($label) }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control form-select @error('have_offer') is-invalid @enderror"
                                        ...
                                        @foreach (['N' => 'No', 'Y' => 'Yes'] as $value => $label)
                                            <option value="{{ $value }}">
                                                {{ ucfirst($label) }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-md-3">
                                   ...
                                   <input type="date" min="{{ date('Y-m-d') }}" class="form-control @error('offer_expiry') is-invalid @enderror"
                                        id="offer_expiry" name="offer_expiry""
                                        placeholder="Date">
                                    @error('offer_expiry')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                 ...
                                 <div class="col-md-3">
                                   ...
                                   <input type="number" class="form-control @error('offer_month') is-invalid @enderror"
                                        id="offer_month" name="offer_month" value=""
                                        placeholder="Month">
                                    @error('offer_month')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
