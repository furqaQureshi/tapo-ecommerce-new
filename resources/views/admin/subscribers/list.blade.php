                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="p-0">
                                    <h4 class="card-title mb-0 flex-grow-1">Subscribers</h4>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#users-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('admin.subscriber.get') }}",
                    type: "GET",
                ...
                columns: [{
                    ...
                    {
                        data: 'is_currently_pregnant',
                        name: 'is_currently_pregnant'
                    },
                    {
                        data: 'is_first_time_mother',
                        name: 'is_first_time_mother',
                    },
                    {
                        data: 'due_date',
                        name: 'due_date'
