                                ...
                                <div class="card card-animate">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4">RM<span
                                                        class="counter-value"
                                                        data-target="{{ number_format($totalOrder, 2) }}">0</span>
                                                </h4>
                                ...
                                <div class="card card-animate">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                        data-target="{{ number_format($userCount / 1000000, 2) }}">0</span>
                                                </h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Pending
                                                    Orders</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                ...
                                                <a href="{{ route('admin.orders.list') }}"
                                                    class="text-decoration-underline">View orders</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header p-0 border-0 bg-light-subtle">
                                        <div class="row g-0 text-center">
                                            ...
                                            <div class="col-6 col-sm-3">
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1">RM<span class="counter-value"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h5 class="fs-14 my-1 fw-normal">
                                                                    RM{{ number_format($product->price, 2) }}</h5>
                                                                <span class="text-muted">Price</span>
                                                            </td>
                                                            <td>
                                                                <h5 class="fs-14 my-1 fw-normal">
                                                                    {{ $product->order_count }}</h5>
                                                                <span class="text-muted">Orders</span>
                                                            </td>

                                                            <td>
                                                                <h5 class="fs-14 my-1 fw-normal">
                                                                    RM{{ number_format($product->total_amount, 2) }}</h5>
                                        ...
                                        <div
                                            ...
                                            <div class="col-sm">
                                                <div class="text-muted">
                                                    Showing <span
                                                        class="fw-semibold">{{ $bestSellingProducts->count() }}</span> of
                                                    <span class="fw-semibold">{{ $bestSellingProducts->count() }}</span>
                                                    Results
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    @foreach ($recentOrders as $order)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 me-2">
                                                                        <img src="{{ asset($order->avatar) ?? 'assets/images/users/avatar-placeholder.jpg' }}"
                                                                            alt="{{ $order->customer_name }}"
                                                                            class="avatar-xs rounded-circle material-shadow" />
                                                                    </div>
                                                                    <div class="flex-grow-1">{{ $order->customer_name }}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-success">RM{{ number_format($order->grand_total, 2) }}</span>
                                                            </td>
                                                            <td>
                                                                <span
                                                                    class="badge {{ $order->status == 'completed' ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }}">
                                ...
                                <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="text-muted lh-base">Refer a new seller to us and earn RM100 per
                                                refer.
                                            </p>
