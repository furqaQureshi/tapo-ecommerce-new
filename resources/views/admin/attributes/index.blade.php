                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="p-0">
                                    <h4 class="card-title mb-0 flex-grow-1">Attributes</h4>
                                </div>
                                <div class="p-0">
                                    <a href="{{ route('admin.attribute.add') }}" class="btn btn-danger"
                                        data-name="categoryAdd"><img src="{{ asset('admin/assets/images/svg/add.svg') }}"
                                            width="12" class="me-1"> Add Attribute</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        $(document).ready(function() {
            var table = $('#categories-table').DataTable({
                ...
                fnInitComplete: function() {
                    $('#categories-table').removeClass('d-none').fadeIn();
            ...
            $(document).on('change', '.status', function() {
                ...
                var url = "{{ route('admin.attribute.status', ':id') }}";
            ...
            $(document).on('click', '.delete-btn', function() {
                var id = $(this).data('id');
                var url = "{{ route('admin.attribute.destroy', ':id') }}";
                url = url.replace(':id', id);
