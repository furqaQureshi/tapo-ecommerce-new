                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-0">
                                    <a href="{{ route('shipping.create') }}" class="btn btn-danger" data-name="shippingAdd">
                                        <img src="{{ asset('admin/assets/images/svg/add.svg') }}" width="12"
                                            class="me-1"> Add Shipping
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            var table = $('#shipping-table').DataTable({
                ...
                fnInitComplete: function() {
                    $('#shipping-table').removeClass('d-none').fadeIn();
            ...
            $(document).on('click', '.dltBtn', function(e) {
                ...
                swal({
                    title: "Are you sure?",
                    text: "Once deleted, you will not be able to recover this shipping method!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                toastr.error('Failed to delete shipping method!');
                            }
                        });
                    } else {
                        swal("Your shipping method is safe!");
                    }
                });
            });
        });
