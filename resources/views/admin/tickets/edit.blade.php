                            ...
                            <form action="{{ route('admin.ticket.update', $ticket->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $ticket->name) }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="image" type="file" class="dropify"
                                        data-default-file="{{ asset($ticket->image) }}"
                                        id="image" data-height="180"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="0" {{ old('status', $ticket->status) == '0' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
