                                ...
                                <div class="account-details">
                                    <div class="account-info">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h3 class="mb-0">{{ __('lang.information') }}</h3>
                                        ...
                                        <table class="table transaction-table" id="orderTable" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ __('lang.Order_Type') }}</th>
                                                    <th class="text-center">{{ __('lang.Payment_Method') }}</th>
                                                    <th class="text-center">{{ __('lang.Amount') }}</th>
                                                    <th class="text-center">{{ __('lang.status') }}</th>
                                                    <th class="text-center">{{ __('lang.Refund') }}
                                                        {{ __('lang.status') }}</th>
