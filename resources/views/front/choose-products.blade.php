...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" style="background-color: aliceblue !important;" class="btn btn-danger btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="shop-details-image">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="shop-thumb" id="product-gallery">
                                    ...
                                    <div id="modal-gallery" class="d-flex flex-wrap gap-2 justify-content-center"></div>
                                ...
                                <div class="product-details-content">
                                    ...
                                    <div class="cart-wrp">
                                        ...
                                        <div class="social-profile">
                                            ...
                                            <ul>
                                                <li>
                                                    <a id="pop-fb" href="#" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                                </li>                  
                                                <li>
                                                    <a id="pop-ins" href="#" target="_blank"><i class="fab fa-instagram"></i></a>
                                                </li>
                                                <li>
                                                    <a id="pop-tik" href="#" target="_blank"><i class="fa-brands fa-tiktok"></i></a>
                                                </li>
                                            </ul>
                                    ...
                                    <h6 class="details-info">
                                        ...
                                        <a id="modal-product-category" href="javascipt:void(0)">N/A</a>
    ...
    <section class="pages-banner-section">
        ...
        <div class="hero-2">
            ...
            <div class="hero-bg" style="background-image: url(front/assets/img/zera-pattern.jpg)">
            ...
            <div class="product-details-wrapper row">
                ...
                <div class="col-lg-4 shop-products-grid choose-products-grid sidebar-steps sidebar-steps-desk">
                    ...
                    <div class="step-indicator">
                            ...
                            <div class="section-title-area">
                                ...
                                <div class="section-title style-3">
                                    ...
                                    <p>
                                        ...
                                        (Including mystery product customised for you)
                        ...
                        <div class="step-navi step-2">2. Select Plan</div>
                                    ...
                                    <label for="{{ $inputId }}" class="pricing-label">
                                        ...
                                        <div class="pricing-box">
                                            ...
                                            <div class="plan-details">
                                                ...
                                                <p class="savings">{{ $plan->description }}</p>
                        ...
                        <div class="step-navi step-3" style="display: none;">3. Checkout</div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="row g-4">
                                        ...
                                        <div class="product-collection-item" data-product-id="{{ $product->id }}"
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-product-media='@json($product->media->map(fn($m) => asset($m->image_path)))'

                                                    data-product-sku="{{ $product->sku ?? 'N/A' }}"

                                                    data-product-category='@json($product->categories ?? [])'

                                                    data-product-tags="{{ implode(',', $product->tags ?? ['accessories', 'business']) }}"
                                                    data-product-url="{{ route('product.detail',$product->slug) }}"
                                                ...
                                                @if ($product->label === 'zeera_pick')
                                                    ...
                                                    <div class="badge badge-warning">ZÉRA Pick</div>

                                                @elseif ($product->label === 'addon' && $product->addon_price)

                                                    <div class="badge badge-danger">+ RM{{ number_format($product->addon_price, 0) }}</div>
                                            ...
                                            <div class="product-content">
                                                ...
                                                <a href="#" class="product-details-link" data-bs-toggle="modal"
                                                    ...
                                                    data-product-category="{{ $product->categories ?? 'N/A' }}"
                                                ...
                                                @else
                                                    ...
                                                    <p><span
                                                            ...
                                                            class="pro-price-{{ $product->id }}">RM{{ number_format($product->price, 2) }}</span>
                            ...
                            @else
                                ...
                                <div class="no-bundle-msg"

                                    style="color: #555; font-style: italic; padding:10px; background:#f9f9f9; border:1px solid #ddd; border-radius:6px;">

                                    At the moment, no bundle products are available for this item.

                                    We are working on adding exciting bundle offers soon.

                                    Please check back later to explore bundle deals and save more on your purchase!
    ...
    <style>
        ...
        .badge-warning {
          ...
          background: url('../front/assets/img/zera-pick.png') no-repeat;
        ...
        .badge-danger {
          ...
          background: url('../front/assets/img/zera-pick-dis.png') no-repeat;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.product-details-link').on('click', function(e) {
                ...
                const productMedia = $(this).data('product-media');

                const productDescription = $(this).data('product-description');
                const proUrl = $(this).data('product-url');
                ...
                var pGallery = '<div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">';
                             
                pGallery += '<div class="carousel-inner">';
                pGallery += '<div class="carousel-item active">';
                pGallery += '<img src="'+productImage+'" class="d-block w-100" alt="...">';
                pGallery += '</div>';

                productMedia.forEach((url, i) => {
                    pGallery += '<div class="carousel-item">';
                    pGallery += '<img src="'+url+'" class="d-block w-100" alt="...">';
                    pGallery += '</div>';
                });

               
                pGallery += '</div>';
                pGallery += '<button  class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">';
                pGallery += '<span class="carousel-control-prev-icon" aria-hidden="true"></span>';
                pGallery += '<span class="visually-hidden">Previous</span>';
                pGallery += '</button>';
                pGallery += '<button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">';
                pGallery += '<span class="carousel-control-next-icon" aria-hidden="true"></span>';
                pGallery += '<span class="visually-hidden">Next</span>';
                pGallery += '</button>';
                pGallery += '</div>';


                $('#product-gallery').html(pGallery);

                $('#modal-product-image').attr('src', productImage).attr('alt', productName);

                $('#modal-product-description').html(productDescription);
                $('#pop-fb').attr('href','https://www.facebook.com/sharer/sharer.php?u='+proUrl);
                $('#pop-ins').attr('href','https://www.instagram.com/create/details/?url='+proUrl);
                $('#pop-tik').attr('href','https://www.tiktok.com/share/url?url='+proUrl);
                ...
                if (productCategory && productCategory.length > 0) {
                    ...
                    productCategory.forEach((val, i) => {

                        productCategoryHtml += `

                            <a

                                href="${window.baseURL}/category/${val.unique_id}/${val.slug}">
                    ...
                    $('#modal-product-category').html(productCategoryHtml);

                } else {

                    $('#modal-product-category').empty();
