                                        ...
                                        <div class="op-main-container text-center">
                                            ...
                                            <div class="op-order-details">
                                                ...
                                                <div class="op-order-row">
                                                   ...
                                                   <span>
                                                        {{ $order->address }},
                                                        {{ $order->city->name ?? 'City Missing' }},
                                                        {{ $order->state->name ?? 'State Missing' }},
                                                    </span>
                                                </div>
                                                ...
                                                <div class="op-order-row">
                                                    ...
                                                    <span>PKR {{ number_format($order->grand_total) }}</span>
                                                </div>
                                            ...
                                            <div class="op-btn-group">
                                                ...
                                                <a href="{{ route('front.home') }}" class="op-btn op-btn-secondary">Continue Shopping</a>
                                            </div>
