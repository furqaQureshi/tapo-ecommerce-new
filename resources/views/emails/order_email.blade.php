    ...
    <table width="100%" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td
                ...
                <img src="{{ $mailData['logo'] }}" alt="{{ config('app.name') }}"
                    style="max-width: 120px; margin-bottom: 10px;">
                <h2 style="margin: 0; font-size: 24px; font-weight: 400;">Order {{ $mailData['status'] }}!</h2>
                <p style="margin: 5px 0 0; font-size: 14px; opacity: 0.9;">{{ $mailData['short_msg'] }}</p>
            </td>
        </tr>
        <tr>
            <td style="padding: 30px;">
                <p style="font-size: 20px; color: #333; font-weight: 400; margin-bottom: 10px;">Hi {{ $mailData['user'] }},
                </p>
                <p style="color: #555; font-size: 16px; margin-bottom: 20px;">{{ $mailData['long_msg'] }}</p>
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px 15px; color: #333; font-size: 14px;">#{{ $mailData['order_no'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 15px; font-weight: 500; width: 40%; color: #333; font-size: 14px;">
                            <strong>Product:</strong>
                        </td>
                        <td style="padding: 10px 15px; color: #333; font-size: 14px;">{{ $mailData['product'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 15px; font-weight: 500; width: 40%; color: #333; font-size: 14px;">
                            <strong>Order Date:</strong>
                        </td>
                        <td style="padding: 10px 15px; color: #333; font-size: 14px;">{{ $mailData['order_date'] }}</td>
                    </tr>
                </table>
